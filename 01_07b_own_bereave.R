...
#' Output: out/figures/01_07b_own_bereave_twfe.png
#' =============================================================================

source('config.R')
source('utils/logging.R')
log_init("01_07b_own_bereave.R")
...
png(file.path(CONFIG$figures_dir, "01_07b_own_bereave_twfe.png"), width = 900, height = 500)
...
log_message("01_07b_own_bereave.R completed successfully")
