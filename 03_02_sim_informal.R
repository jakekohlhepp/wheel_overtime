## we hold fix the number of officers who work each day at the observed
## but we choose based on the model index.
...
for (iter in 1:max_iter){
  ...
  results<-rbind(results, data.table(network_reduce=net,access_cost=cost,sim_num=iter,safety_prod=sum(all_pairs$sim_prod),
