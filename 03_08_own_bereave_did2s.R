#' =============================================================================
#' BEREAVEMENT EVENT STUDY - Gardner (2022) did2s Imputation Estimator
#' (Own Effects)
#' =============================================================================
#' Input:  data/02_01_estimation_sample.rds
#' Output: out/figures/03_08_own_bereave_did2s.png
#' =============================================================================

source('config.R')
source('utils/logging.R')
log_init("03_08_own_bereave_did2s.R")
...
png(file.path(CONFIG$figures_dir, "03_08_own_bereave_did2s.png"), width = 900, height = 500)
iplot(did2s_es, main = "", xlab = "Time to Bereavement (Days)", ylab = "Potential Supplier Count",
...
log_message("03_08_own_bereave_did2s.R completed successfully")
