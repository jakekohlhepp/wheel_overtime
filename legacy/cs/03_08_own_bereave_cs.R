#' =============================================================================
#' BEREAVEMENT EVENT STUDY - Callaway & Sant'Anna (2021) Group-Time ATT (Own Effects)
#' =============================================================================
#' Input:  data/02_01_estimation_sample.rds
#' Output: out/figures/03_08_own_bereave_cs.png
#' =============================================================================

source('config.R')
source('utils/logging.R')
log_init("03_08_own_bereave_cs.R")
...
png(file.path(CONFIG$figures_dir, "03_08_own_bereave_cs.png"), width = 900, height = 500)
print(
  ggplot(es_df) +
    ...
    labs(x = "Time to Bereavement (Days)", y = "Potential Supplier Count") +
...
log_message("03_08_own_bereave_cs.R completed successfully")
