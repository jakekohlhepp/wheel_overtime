#' =============================================================================
#' TERMINATION EVENT STUDY - Callaway & Sant'Anna (2021) Group-Time ATT
#' =============================================================================
#' Input:  data/02_01_estimation_sample.rds
#'         Contact matrix via load_contact_matrix()
#' Output: out/figures/03_03_termination_cs.png
#' =============================================================================

source('config.R')
source('utils/logging.R')
log_init("03_03_termination_cs.R")
...
png(file.path(CONFIG$figures_dir, "03_03_termination_cs.png"), width = 900, height = 500)
print(
  ggplot(es_df) +
...
log_message("03_03_termination_cs.R completed successfully")
