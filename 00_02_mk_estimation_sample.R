...
#' Output: data/00_02_estimation_sample.rds
#'
#' Output Schema:
...
log_init("00_02_mk_estimation_sample.R")
...
output_path <- file.path(CONFIG$data_dir, "00_02_estimation_sample.rds")
...
message("00_02_mk_estimation_sample complete")
