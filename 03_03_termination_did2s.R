#' =============================================================================
#' TERMINATION EVENT STUDY - Gardner (2022) did2s Imputation Estimator
#' =============================================================================
#' Input:  data/02_01_estimation_sample.rds
#'         Contact matrix via load_contact_matrix()
#' Output: out/figures/03_03_termination_did2s.png
#' =============================================================================

source('config.R')
source('utils/logging.R')
log_init("03_03_termination_did2s.R")
...
log_message("03_03_termination_did2s.R completed successfully")
