...
## allow for different slopes across people

## estimate logit with two-way fixed effects
mod <- alpaca::feglm(ot_work ~ opp_dist+suppliers_interacted+suppliers_interacted:as.factor(num_emp1)+ot_rate+seniority_rank+normal_work | num_emp1, 
