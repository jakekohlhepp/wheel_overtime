...
iplot(twfe_es, main = "", xlab = "Time to Bereavement (Days)", ylab = "Potential Supplier Count",
...
log_message("03_08_own_bereave.R completed successfully")
