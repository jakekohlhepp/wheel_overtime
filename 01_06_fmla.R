...
#' Output: out/figures/01_06_fmla_twfe.png
#' =============================================================================

source('config.R')
source('utils/logging.R')
log_init("01_06_fmla.R")
...
png(file.path(CONFIG$figures_dir, "01_06_fmla_twfe.png"), width = 900, height = 500)
iplot(twfe, main = "", xlab = "Time to Treatment (Days)", ylab = "Connectedness",
      drop = "([3-9]\\d{1}|\\d{3})", lab.fit = "simple")
dev.off()

log_message("01_06_fmla.R completed successfully")
