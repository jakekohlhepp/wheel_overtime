#' =============================================================================
#' FAMILY MEDICAL LEAVE EVENT STUDY - Sun & Abraham (2021) Interaction-Weighted Estimator (Peer Effects)
#' =============================================================================
#' Input:  data/02_01_estimation_sample.rds
#'         Contact matrix via load_contact_matrix()
#' Output: out/figures/03_05_fmla_sunab.png
#' =============================================================================

source('config.R')
source('utils/logging.R')
log_init("03_05_fmla_sunab.R")
...
png(file.path(CONFIG$figures_dir, "03_05_fmla_sunab.png"), width = 900, height = 500)
iplot(sa_es, main = "", xlab = "Time to Treatment (Weeks)", ylab = "Connectedness",
      drop = "([5-9]\\d{0}|[1-9]\\d{1,})", lab.fit = "simple")
dev.off()

log_message("03_05_fmla_sunab.R completed successfully")
