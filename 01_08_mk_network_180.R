## version of 01_06 for the 180 days rolling window.
library('data.table')
library('lubridate')
library('circular')
library('qgraph')
...
## read in data - use 6 month window for now.
data<-fread('mkdata/data/01_03_pre_network_180.csv')
...
saveRDS(all_pairs,"mkdata/data/01_08_panel_working_180.rds")
