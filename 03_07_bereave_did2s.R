...
#' Output: out/figures/03_07_bereave_did2s.png
#' =============================================================================

source('config.R')
source('utils/logging.R')
log_init("03_07_bereave_did2s.R")
...
png(file.path(CONFIG$figures_dir, "03_07_bereave_did2s.png"), width = 900, height = 500)
iplot(did2s_es, main = "", xlab = "Time to Treatment (Days)", ylab = "Connectedness",
      drop = "([3-9]\\d{1}|\\d{3})", lab.fit = "simple")
dev.off()

log_message("03_07_bereave_did2s.R completed successfully")
