...
#' Output: out/figures/01_07_bereave_twfe.png
#' =============================================================================

source('config.R')
source('utils/logging.R')
log_init("01_07_bereave.R")
...
png(file.path(CONFIG$figures_dir, "01_07_bereave_twfe.png"), width = 900, height = 500)
iplot(twfe, main = "", xlab = "Time to Treatment (Days)", ylab = "Connectedness",
      drop = "([3-9]\\d{1}|\\d{3})", lab.fit = "simple")
dev.off()

log_message("01_07_bereave.R completed successfully")
