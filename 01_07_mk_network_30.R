## version of 01_06 for the 30 days rolling window.
library('data.table')
library('lubridate')
library('circular')
library('qgraph')
...
## read in data - use 1 month window for now.
data<-fread('mkdata/data/01_03_pre_network_30.csv')
...
saveRDS(all_pairs,"mkdata/data/01_07_panel_working_30.rds")
